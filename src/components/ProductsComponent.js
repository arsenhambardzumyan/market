...
const ProductsComponent = ({ title, products, pagination, template, addProductToCart }) => {
  ...
  return (
    ...
    <div className="uk-section uk-container">
        ...
        <div className={isToggled ? 'uk-grid uk-grid-medium uk-child-width-1-1@m uk-child-width-1-3@s product_listing' : 'uk-grid uk-grid-medium uk-child-width-1-3@m uk-child-width-1-2@s product_listing'} data-uk-grid ref={productListEl}>
