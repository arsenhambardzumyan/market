                                ...
                                <div className="section-content">
                                    <Form noValidate validated={validated} onSubmit={handleSubmit}>
                                        <div className="uk-grid uk-grid-small uk-child-width-1-3@s" data-uk-grid>
                                            ...
                                            <Form.Group controlId="validationCustom04" className="textarea_inner">
                                            ...
                                            <Button className="uk-button uk-button-danger uk-button-large" type="submit">Submit form</Button>
                                            </div>
                                        </div>
                                    </Form>
                                </div>
